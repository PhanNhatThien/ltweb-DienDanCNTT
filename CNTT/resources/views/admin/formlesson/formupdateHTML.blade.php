...
Cập nhật bài học - HTML
@endsection
@section('content-main')


<div class="flex">
    <h1>Cập nhật bài học HTML-CSS</h1>
</div>
<div class="formAdd_wrapper">
    <div class="formAdd_container">
        ...
        <div class="formAdd_body">
            <form action="{{ route('formadd.html.postupdate')}}" method="post" class="form_formAdd">
                @csrf
                <div class="form_item">
                ...
                <div style="display: flex;">
                    ...
                    <a style="padding: 8px 13px;font-size: 1.6rem;margin-top: 20px;" class="btn btn-warning" href="{{ route('manage.html.index') }}">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
