...
<div class="content_route">
    ...
    <div class="defaultLayout_container">
        <div class="defaultLayout_container-top">
            <h1 class="defaultLayout_heading">Lộ trình học Front-end</h1>
    ...
    <div class="defaultLayout_container defaultLayout_container-active ">
        <div class="defaultLayout_container-top">
            ...
            <p class="defaultLayout_heading-text">Một websites hay ứng dụng hiện đại rất phức tạp, chỉ sử dụng HTML, CSS, Javascript theo cách code thuần (tự code từ đầu tới cuối) sẽ rất khó khăn. Vì vậy các Libraries, Frameworks ra đời nhằm đơn giản hóa, tiết kiệm chi phí và thời gian để hoàn thành một sản phẩm website hoặc ứng dụng mobile.
        </div>
        <div>
