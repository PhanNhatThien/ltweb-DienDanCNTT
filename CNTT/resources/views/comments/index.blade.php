...
<div class="content-comments">
    ...
    @endif
    <div class="form-wrap">
        <form action="{{ route('commentPage.comment') }}" method="get" class="commentBox_commentWrapper">
            @csrf
            <div class="form-body">
                <i class="comment-item-ava-cmt fa-sharp fa-solid fa-user-tie"></i>
                <div class="form-body-input">

                    <input class="text_text commentBox_commentInput" value="{{ old('comment') }}" name="comment" type="text" placeholder="Bạn có thắc mắc gì không?">
                    @error('comment')
            ...
            <div class="commentBox_actionWrapper">
                <span class="commentBox_cancel">Hủy</span>
                <button class="commentBox_cmt">Bình luận</button>
            </div>
        </form>
    </div>
